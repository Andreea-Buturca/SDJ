...
public class TripController extends Controller implements Initializable {
    ...
    private void loadBusList() {
        ...
        if (busType.getValue().equals("Mini Bus"))
            buses = new BusList(DataHandler.getBusList().searchByType("client.Model.MiniBus"));
        else if (busType.getValue().equals("Party Bus"))
            buses = new BusList(DataHandler.getBusList().searchByType("client.Model.PartyBus"));
        else if (busType.getValue().equals("Luxury Bus"))
            buses = new BusList(DataHandler.getBusList().searchByType("client.Model.LuxuryBus"));
        else buses = new BusList(DataHandler.getBusList().searchByType("client.Model.ClassicBus"));
